...
const Hero = () => {
  return (
    <section className={`${styles.showcaseMargin} my-5 sm:my-20 sm:mx-20 sm:flex`}>
      <div className={`sm:w-full sm:justify-between sm:flex ${styles.heroFlex}`}>
        <div className='flex-1 py-6'>
          ...
          <div className={`flex ${styles.heroCenter}`}>
        ...
        <div className={`flex ${styles.heroCenter}`}>
          <div className='pt-0 mr-2 sm:mr-0 sm:pt-16 sm:flex sm:flex-col'>
